...
void setup_scr_screen_3(lv_ui *ui)
{
    ...
    lv_img_set_src(ui->screen_3_img_1, "C:\\Users\\TX\\Desktop\\gui_project\\esp32-s3\\import\\image\\heiji9.png");
#else
    lv_img_set_src(ui->screen_3_img_1, "F:/heiji9.bin");
#endif
    lv_img_set_pivot(ui->screen_3_img_1, 50,50);
    lv_img_set_angle(ui->screen_3_img_1, 0);
    lv_obj_set_pos(ui->screen_3_img_1, -3, 0);
    lv_obj_set_size(ui->screen_3_img_1, 320, 240);
